            ...
            <tbody>
                ...
                <?php 
                    ...
                    foreach($go_query as $row){
                        ...
                        echo "<td><a href='user-list.php?action=delete&cid={$id}' class='btn btn-danger' onclick=\"return confirm('Are you sure?')\">DELETE</a></td>";
                        //echo "<td><type='submit' name='button' a href='user-list.php?action=edit&cid={$id}' class='btn btn-primary' onclick=\"OpenModel('{$id}', '{$username}')\">EDIT</a>";
                        echo "<td><type='submit' name='button' a href='user-list.php?action=edit&cid={$id}' class='btn btn-primary' onclick=\"OpenModel('{$id}', '{$username}')\">EDIT</a>";
